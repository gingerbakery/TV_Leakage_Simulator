#!/usr/bin/env node
/**
 * Package the synthetic right-side horizontal seam STEP/setup fixtures as settings-only
 ...
 *
 * node scripts/horizontal_seam_project_helper.mjs
 */
...
const directory = resolve(root, 'samples/side_seam_horizontal')
const cases = ['horizontal_gap_0p3_off', 'horizontal_gap_0p3_1x', 'horizontal_gap_0p3_4x', 'horizontal_gap_0p3_16x', 'horizontal_gap_0p1_1x', 'horizontal_gap_0p5_1x']
